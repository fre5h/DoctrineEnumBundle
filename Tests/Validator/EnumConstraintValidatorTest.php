...
use Fresh\DoctrineEnumBundle\Validator\Constraints\EnumConstraintValidator;
 ...
 * EnumValidatorTest
 */
final class EnumConstraintValidatorTest extends TestCase
{
    /** @var EnumConstraintValidator */
    ...
    {
        $this->enumValidator = new EnumConstraintValidator();
    ...
    {
        $constraint = new EnumConstraint(entity: '');
